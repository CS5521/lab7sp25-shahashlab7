...
main(int argc, char *argv[])
{
  ...
  47:	e8 68 04 00 00       	call   4b4 <mkdir>
  ...
  66:	c7 44 24 04 bf 09 00 	movl   $0x9bf,0x4(%esp)
  6d:	00 
...
void ps(void) {
  ...
  ce:	c7 44 24 04 dc 09 00 	movl   $0x9dc,0x4(%esp)
  d5:	00 
 ...
 135:	8b 04 85 08 0a 00 00 	mov    0xa08(,%eax,4),%eax
 13c:	ff e0                	jmp    *%eax
 ...
 1dc:	c7 44 24 04 f5 09 00 	movl   $0x9f5,0x4(%esp)
 1e3:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 575:	0f b6 80 9c 0c 00 00 	movzbl 0xc9c(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 6d2:	75 09                	jne    6dd <printf+0x101>
          s = "(null)";
 6d4:	c7 45 f4 20 0a 00 00 	movl   $0xa20,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 79e:	a1 b8 0c 00 00       	mov    0xcb8,%eax
 ...
 869:	a3 b8 0c 00 00       	mov    %eax,0xcb8
}
 86e:	c9                   	leave  
 86f:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8bc:	e8 ce fe ff ff       	call   78f <free>
  return freep;
 8c1:	a1 b8 0c 00 00       	mov    0xcb8,%eax
}
 8c6:	c9                   	leave  
 8c7:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8da:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8dd:	a1 b8 0c 00 00       	mov    0xcb8,%eax
 8e2:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8e5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8e9:	75 23                	jne    90e <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8eb:	c7 45 f0 b0 0c 00 00 	movl   $0xcb0,-0x10(%ebp)
 8f2:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8f5:	a3 b8 0c 00 00       	mov    %eax,0xcb8
 8fa:	a1 b8 0c 00 00       	mov    0xcb8,%eax
 8ff:	a3 b0 0c 00 00       	mov    %eax,0xcb0
    base.s.size = 0;
 904:	c7 05 b4 0c 00 00 00 	movl   $0x0,0xcb4
 90b:	00 00 00 
  }
 ...
 961:	a3 b8 0c 00 00       	mov    %eax,0xcb8
      return (void*)(p + 1);
 ...
 96c:	eb 38                	jmp    9a6 <malloc+0xde>
    ...
    if(p == freep)
 96e:	a1 b8 0c 00 00       	mov    0xcb8,%eax
